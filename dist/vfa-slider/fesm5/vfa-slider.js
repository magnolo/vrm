...
var VfaSliderComponent = /** @class */ (function () {
    ...
    VfaSliderComponent.prototype.setActive = function (idx) {
        ...
        var length = path.scrollHeight > 0 && path.getTotalLength ? path.getTotalLength() : 0;
        if (plane) {
